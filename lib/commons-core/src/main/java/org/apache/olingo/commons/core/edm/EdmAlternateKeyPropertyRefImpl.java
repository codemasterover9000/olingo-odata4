...
public class EdmAlternateKeyPropertyRefImpl implements EdmAlternateKeyPropertyRef {
  ...
  public EdmAlternateKeyPropertyRefImpl(final EdmEntityType edmEntityType, final CsdlPropertyRef ref) {
  ...
  public EdmProperty getProperty() {
    if (property == null) {
      if (getAlias() == null) {
        ...
        if (property == null) {
          throw new EdmException("Invalid alternate key property ref specified. Can´t find property with name: "
              + getName());
        }
      } else {
